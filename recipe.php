<?php
    ...
    if(isset($_GET['id']) && is_numeric($_GET['id'])) {
        ...
        $query = "SELECT * FROM foods WHERE id_food = $id";
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="food.php">Food Recomendations</a>
                    </li>
                    <li class="active">
                        ...
                        <div class="ibox-content">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-7">
                                    ...
                                    <div class="m-t-md">
                                        <h2 class="product-main-price"><?php echo $row['calory_produced']?> Calory<small class="text-muted"></small> </h2>
                                    </div>
                                    <hr>
                                    ...
                                    <?php if ($_SESSION['level'] == 'Admin') { ?>
                                            <div>
                                                <div class="btn-group">
                                                    <a href="editfood.php?id=<?php echo $id ?>" class="btn btn-white btn-sm"><i class="fa fa-pencil"></i> Update </a>
